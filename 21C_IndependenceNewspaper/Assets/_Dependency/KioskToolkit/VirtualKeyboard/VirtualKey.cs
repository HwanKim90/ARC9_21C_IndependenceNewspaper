...
namespace Arc9.Unity.KioskToolkit.Keyboard
{
    public class VirtualKey : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
    {
        ...
        static Color _Textcolor = new Color32(100, 100, 100, 0xff);
        ...
        void Update()
        {
            ...
            switch (KeyType)
            {
                ...
                case kType.kCapsLock:
                    ...
                    break;
                case kType.kHangulKey:
                    {
                        if (_Keybord.Language == VirtualKeyboard.kLanguage.kKorean)
                        {
                            mLanguageBtnTxtKor.color = Color.clear;
                            mLanguageBtnTxtEng.color = _Textcolor;
                        }
                        else
                        {
                            mLanguageBtnTxtKor.color = _Textcolor;
                            mLanguageBtnTxtEng.color = Color.clear;
                        }
                    }
                    break;
            }
